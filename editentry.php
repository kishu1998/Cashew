 ...
 <div class="panel panel-default">
		  <div class="panel-heading">Work Details </div>
			<div class="panel-body">
				...
				<form action="editworkentry.php" method="POST">	
				<?php echo date('d/m/Y'); ?>
		...
		$date1=date("Y-m-d",strtotime($date1));
                                ...
                                while($row=mysqli_fetch_array($res))
                                  {
								   ...
								   {	
										...
										$sh=$row['cashew_shelled'];
							   echo "<td><input  type='number' value='".$sh."'  name='contents".$i."'/></td>";
										
									}
									else
									{
										
										echo "<td name='contents".$k."'>".$row['cashew_shelled']."</td>";
				...
				<center><input type="submit" class="btn btn-lg" value="UPDATE"/></center>
					</form>
				</div>
		   </div>
</div>
